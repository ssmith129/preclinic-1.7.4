...
var Element = /*#__PURE__*/function () {
  function Element(_item) {
    ...
    this.changeValueToVars = function (k, value, skipPlugin) {
      var isArray = (Array.isArray(value) || k.match(/color|fill|stroke|.*shadow/i) && typeof value === 'string' || typeof value === 'string' && value.split(/[\s|,]/).length > 1) && !(k in _.Plugins);
    ...
    this.startAt = (0, _objectSpread2.default)({}, _item.startAt);
